...
Status: Archived on 2026-07-14. MVP closed around the accepted household scope. Unchecked Trip,
ingestion-review, Crawl Snapshot, and combined evidence below was transferred to Phase 1 rather than
counted as passed or waived.

The decision record is the archived
[`scripts/mvp/stage11-mvp-manual-test.md`](../../scripts/mvp/stage11-mvp-manual-test.md); active
acceptance is in [`scripts/phase1-manual-test.md`](../../scripts/phase1-manual-test.md).
