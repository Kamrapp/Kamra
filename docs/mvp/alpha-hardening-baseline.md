...
Configured Mongo smoke, migration/reconciliation, archive/restore, and browser acceptance were not run in this baseline because they require the approved environment and human/browser evidence. Their historical disposition is tracked in `scripts/mvp/stage11-mvp-manual-test.md`.
