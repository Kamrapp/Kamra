...
- Path: `.agents/sessions/mvp/2026-07-09-stage-6-shopping-list-planning.md`
...
Review and approve or revise `.agents/plans/mvp/2026-07-09-stage-6-shopping-list-low-stock-notices-plan.md`; if approved, start with Step 1 contracts, generic shops, and pure generator.
