...
- Date: 2026-07-13
- Plan: `.agents/plans/mvp/2026-07-13-stage-11-vertical-slice-locality-plan.md`
...
- Captured the first capability ownership map in `docs/mvp/vertical-slice-map.md`.
...
- Added the live runbook `scripts/mvp/stage11-mvp-manual-test.md`; the former Stage 8 script and Stage 8–10 checklist were reviewed, consolidated, and removed as duplicate acceptance sources.
...
- Replaced the Section 4 implementation reminders in `scripts/mvp/stage11-mvp-manual-test.md` with
...
- Rewrote `scripts/mvp/stage11-mvp-manual-test.md` as the single manual-only Stage 8–11 runbook. Active
...
- `docs/mvp/vertical-slice-map.md`
...
- Updated the automated coverage ledger in `scripts/mvp/stage11-mvp-manual-test.md` as `f23478e`.
...
Execute `scripts/mvp/stage11-mvp-manual-test.md` as one continuous Stage 8–11 pass, starting with the
...
- Approved and implemented the bounded `.agents/plans/mvp/2026-07-14-mvp-quality-automation-plan.md`
...
`npm run smoke:demo-household`; finish the new manual checks in `scripts/mvp/stage11-mvp-manual-test.md`.
...
- Reconciled `scripts/mvp/stage11-mvp-manual-test.md` so active sections contain only real seeded,
