...
Manual/browser acceptance is tracked centrally in `scripts/mvp/stage11-mvp-manual-test.md`, including the Stage 8 prerequisite and Stage 9 journey. This plan must not grow a competing checklist.
