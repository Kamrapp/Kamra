...
Status: Closed and archived on 2026-07-14. Technical implementation completed; household-side manual
acceptance passed, while Trip/pricing/ingestion-review and Crawl Snapshot acceptance transferred to
Phase 1 because those workflows will be redesigned. This was the single technical and manual wrap-up stage
...
`scripts/mvp/stage11-mvp-manual-test.md`; it combines the existing Stage 8 demo coverage, the Stage 8–10
...
- Add a concise `docs/mvp/vertical-slice-map.md` mapping capability → backend owner paths, route
...
- Update `docs/architecture.md`, `docs/mvp/vertical-slice-map.md`, `scripts/README.md`, the roadmap,
...
- Create and maintain `scripts/mvp/stage11-mvp-manual-test.md` as a live operator document. It must
...
Status: Closed with the revised acceptance boundary recorded in
...
- Update `docs/mvp/alpha-release-checklist.md`, `docs/mvp/vertical-slice-map.md`, the roadmap, and the
