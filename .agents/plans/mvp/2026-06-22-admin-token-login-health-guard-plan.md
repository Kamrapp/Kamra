...
Status: Superseded by `.agents/plans/mvp/2026-06-22-user-token-login-health-guard-plan.md` and the Stage 2 finalization plan in `.agents/plans/mvp/2026-06-23-finalize-stage-2-plan.md`.
...
- Add Angular login screen and unauthorized health placeholder.
