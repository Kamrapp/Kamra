...
- `.agents/plans/mvp/2026-06-22-stage-2-serverless-foundation-plan.md`
- `.agents/plans/mvp/2026-06-22-home-health-navigation-fix-plan.md`
- `.agents/plans/mvp/2026-06-22-health-checklist-errors-plan.md`
- `.agents/plans/mvp/2026-06-22-user-token-login-health-guard-plan.md`
- `.agents/plans/mvp/2026-06-22-admin-token-login-health-guard-plan.md`
- `.agents/sessions/mvp/2026-06-22-stage-2-serverless-foundation.md`
- `.agents/sessions/mvp/2026-06-22-user-token-login-health-guard.md`
...
- Files likely affected:
  ...
  - `.agents/plans/mvp/2026-06-22-stage-2-serverless-foundation-plan.md`
  - `.agents/plans/mvp/initial-mvp-roadmap.md`
  - `.agents/plans/mvp/mvp-followups.md`
  - `docs/tech-ops.md`
- Validation:
