...
- `.agents/plans/mvp/2026-07-10-database-maintenance-registry-plan.md`
- `.agents/plans/mvp/2026-07-10-stage-7-controlled-alpha-access-plan.md`
- `.agents/sessions/mvp/2026-07-09-stage-6-shopping-list-implementation.md`
- `.agents/sessions/mvp/2026-07-10-frontend-composition-cleanup.md`
...
The human verification list is maintained centrally in `scripts/mvp/stage11-mvp-manual-test.md`; keep this section aligned with that file rather than creating a second checklist.
