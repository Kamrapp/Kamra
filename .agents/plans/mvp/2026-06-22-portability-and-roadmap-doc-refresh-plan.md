...
- `.agents/sessions/mvp/2026-06-21-bootstrap-docs.md`
...
- Reflect this frame in `docs/repo-bootstrap-standard.md`, `AGENTS.md`, and `.agents/plans/mvp/initial-mvp-roadmap.md`.
...
- Files likely affected: `.agents/plans/mvp/initial-mvp-roadmap.md`
