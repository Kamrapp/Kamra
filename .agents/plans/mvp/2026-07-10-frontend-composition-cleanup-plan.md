...
- `.agents/plans/mvp/2026-07-08-code-cleanup-validation-plan.md`
...
- Files likely affected:
  ...
  - `.agents/plans/mvp/initial-mvp-roadmap.md` only to note the cleanup is completed before Stage 8, not to change Stage 8 scope
- Validation:
  - `npm run test`
  - `npm run typecheck`
  - `npm run lint`
