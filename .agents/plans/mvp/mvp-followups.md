...
Status: Archived with the closed MVP on 2026-07-14. Items promoted into the active Phase 1 scope are
defined in `.agents/plans/phase-1-usability-completion-plan.md`; the rest are historical candidates,
not approved work.
