...
export const databaseMaintenanceEntries: readonly DatabaseMaintenanceEntry[] = [
  ...
  {
    details:
      "Creates the direct country-specific Shop Market and Shopping Trip foundation collections and indexes. This is separate from legacy household shop labels and does not migrate or delete historical shopping lists.",
