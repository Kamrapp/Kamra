...
export function assertStockBatch(value: unknown, label = "stockBatch"): asserts value is StockBatch {
  ...
  assertValue(typeof batch["householdProductId"] === "string" && Boolean(batch["householdProductId"]), `${label}.householdProductId is required`);
...
export function assertCreateManualStockBatchRequest(value: unknown, label = "createManualStockBatchRequest"): asserts value is CreateManualStockBatchRequest {
  ...
  assertValue(typeof request["householdProductId"] === "string" && request["householdProductId"].length > 0, `${label}.householdProductId is required`);
