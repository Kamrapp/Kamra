...
- [ ] Recheck the compact invitation ✓/× actions in both the Home management block and secondary
      rail at a narrow viewport; confirm accessible labels/tooltips remain localized and actions stay
      on one line.
...
| Access and identity          | Protected routes, empty-user household creation, invitation placement/claiming/presentation, isolation, and admin authorization were accepted before `257f07e`.                                                                                                                                                                                    | Compact ✓/× invitation actions remain open above; real multi-user lifecycle remains manual.                                           |
