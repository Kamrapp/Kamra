...
Project notice: Copyright (c) 2026 Kamra contributors.

This repository is source-available under the Elastic License 2.0.

The project owner intends this license to allow learning, review, contribution, private experimentation, and code reuse while preventing third parties from offering Kamra, or a substantially similar hosted copy of Kamra, as a competing public or managed service without written permission.

Hosted-service permissions, advertisement-supported public deployments, seller-sponsored public deployments, trademark permissions, or different licensing terms require separate written approval from the project owner.
