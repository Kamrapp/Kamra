...
@Component({
  ...
  standalone: true,
  template: `<div class="radial-menu" [class.radial-menu-open]="isOpen()">
...
.radial-nav-item {
  ...
  transition: background 160ms ease, border-color 160ms ease, box-shadow 180ms ease, gap 220ms ease, height 240ms cubic-bezier(0.2, 0.9, 0.2, 1.08), min-height 240ms cubic-bezier(0.2, 0.9, 0.2, 1.08), min-width 240ms cubic-bezier(0.2, 0.9, 0.2, 1.08), opacity 180ms ease, padding 240ms cubic-bezier(0.2, 0.9, 0.2, 1.08), transform 260ms cubic-bezier(0.2, 0.9, 0.2, 1.08);
  white-space: nowrap;
  width: 2.35rem;
  z-index: 1;
}
