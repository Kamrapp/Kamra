...
@Component({
  ...
  styles: [
    `
      ...
      .client-console-row time {
        color: inherit;
        opacity: 0.8;
      }
      .client-console-row.debug {
        background: color-mix(in srgb, var(--color-text-muted) 8%, transparent);
      }
      .client-console-row.info {
        background: color-mix(in srgb, var(--color-accent-sky) 12%, transparent);
        color: var(--color-text);
      }
      .client-console-row.warn {
        background: color-mix(in srgb, var(--color-status-warning) 13%, transparent);
        color: var(--color-status-warning);
      }
      .client-console-row.error {
        background: color-mix(in srgb, var(--color-status-danger) 13%, transparent);
